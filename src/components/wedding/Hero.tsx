...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-md flex-1 flex-col items-center px-6 pt-28 text-center">
        <motion.div
        ...
        >
          <motion.p
            ...
            className="text-gold-soft/90 text-[0.6rem] tracking-[0.45em] uppercase font-medium"
          >
          ...
          >
            <span className="text-gold-foil font-display text-4xl sm:text-[3.25rem] font-light tracking-wide">
              {wedding.bride.name}
            </span>
            <span className="font-script text-gold/85 my-1 text-2xl sm:text-3xl">weds</span>
            <span className="text-gold-foil font-display text-4xl sm:text-[3.25rem] font-light tracking-wide">
              {wedding.groom.name}
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-ivory/90 mt-4 text-xs tracking-[0.35em] uppercase font-light"
          >
        ...
        <motion.img
          ...
          className="mt-auto w-[84%] max-w-[320px] brightness-110 contrast-105 drop-shadow-[0_24px_40px_rgba(0,0,0,0.35)]"
        />
      </div>
