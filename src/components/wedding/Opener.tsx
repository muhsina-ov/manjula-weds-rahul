      ...
      <AnimatePresence>
        {!opening && (
          ...
          >
            ...
            <h1 className="text-gold-foil font-display mt-5 flex flex-col items-center text-4xl sm:text-5xl leading-tight font-light">
            ...
            <p className="text-ivory/80 mt-4 text-[0.65rem] tracking-[0.3em] uppercase">
            ...
            <motion.button
              ...
              className="group relative mt-10 grid h-28 w-28 place-items-center"
            ...
            >
              ...
              >
                <span className="font-script text-emerald-ink text-2xl font-bold leading-none">
                  M &amp; R
                </span>
              </motion.span>
            </motion.button>
